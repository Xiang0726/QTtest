...
void Game::final_win()
{
    if(a==3){
                ...
                if(myDlg.c==2) // when the account is gsn
              {
                ...
                QFile file_win("/home/pd2vm/Desktop/qqt/QT test/gsn_win.txt");
                ...
                QFile file("/home/pd2vm/Desktop/qqt/QT test/data.txt");
                ...
                if(myDlg.cc==2) // when the account is 123
              {
                ...
                QFile file_win("/home/pd2vm/Desktop/qqt/QT test/123_win.txt");
                file_win.open(QIODevice::ReadOnly | QIODevice::WriteOnly | QIODevice::Text );
                QTextStream win_in(&file_win);
                win_in >> win_1;
                ++win_1;
                ...
                // rewrite the data in my account
                QFile file("/home/pd2vm/Desktop/qqt/QT test/data_123.txt");
                file.open(QIODevice::ReadOnly| QIODevice::WriteOnly| QIODevice::Text |QIODevice::Truncate );
                QTextStream in(&file);
                in << QObject::tr("你的帳號") << endl;
...
void Game::beginingA(){
    ...
    magic ->setGeometry(-100,500,50,50);
...
void Game::beginingC()
{
    ...
    QFile file_gsn("/home/pd2vm/Desktop/qqt/QT test/gsn_win.txt");
    ...
    QFile file_a123("/home/pd2vm/Desktop/qqt/QT test/123_win.txt");
    ...
    QFile file_rank("/home/pd2vm/Desktop/qqt/QT test/rank.txt");
    ...
    QFile file_rankout("/home/pd2vm/Desktop/qqt/QT test/rank.txt");
